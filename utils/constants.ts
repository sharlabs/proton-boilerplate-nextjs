...
export const LG_FILE_UPLOAD_TYPES_TEXT = 'WEBP, PNG, GIF, JPG. Max 5 MB.';
export const LG_GLB_UPLOAD_TYPES_TEXT = 'GLB. Max 10MB.';
export const SM_FILE_UPLOAD_TYPES_TEXT = 'WEBP, PNG, GIF, JPG. Max 5 MB.';
...
export const GLB_FILE_SIZE_UPLOAD_LIMIT = 10 * 1000000; // 10 MB
...
export const RESIZER_IMAGE_XSM = 'https://bloks.io/cdn-cgi/image/width=32/';
...
export const META = {
  twitterHandle: '@glbdex',
  siteName: 'GLBDEX - 3D Models for the Metaverse | Proton',
  bannerImage: 'https://glbdex.com/og_image_new.jpg',
  description:
    'Start selling and trading your own 3D assets for the metaverse as NFTs, powered by Proton!',
};
